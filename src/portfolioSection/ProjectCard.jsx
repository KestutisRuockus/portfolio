...
export default function ProjectCard({ project }) {
  ...
  function generateUsedTechStackList(arr) {
    return (
      <div>
        <h1 className="text-white text-center font-semibold mb-2">
          Tech Stack:
        </h1>
  ...
  return (
    <div className="w-4/5 md:w-3/5 lg:w-2/5 max-h-[900px] rounded-md p-5 flex flex-col gap-5  items-center border-4 border-[#615545]">
      <div>
      ...
      <h1 className="text-2xl lg:text-3xl text-white uppercase font-bold text-center">
        {project.name}
      </h1>
      <p className="text-white min-h-24 max-h-32 w-full overflow-y-scroll border-2 border-[#615545] p-4 rounded-md">
        {project.description}
      </p>
      <div className="flex max-[400px]:flex-col justify-center gap-6 max-[400px]:w-full text-center">
        ...
        <div className="border-4 px-4 py-2 rounded-2xl border-[#615545] bg-white font-bold text-[#121112] hover:bg-[#444243] hover:border-[#444243] hover:text-white hover:scale-110 transition-all duration-300 cursor-pointer">
