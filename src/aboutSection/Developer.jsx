...
export default function Developer() {
  return (
    <div className="grid grid-cols-1 sm:pt-10 relative cursor-default pt-[110px] p-16">
      {/* links through icons to github, linkedIn */}
      <div className="absolute left-0 top-10 xl:top-1/2 xl:transform xl:-translate-y-1/2 text-white flex sm:flex-col gap-6 ml-5">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-2 mt-14 sm:mt-0 gap-12 xl:gap-0 text-white">
        {/* photo */}
        <div className="text-white col-span-1 justify-self-center relative">
        ...
        <div className="col-span-1 grid grid-rows-5 gap-6 xl:gap-0 w-4/5 xl:w-full justify-self-center xl:pr-10">
          {/* Title */}
          <div className="text-3xl font-bold row-span-1 relative">
            ...
            Front-end Developer
            <span className="text-rose-700 text-xl ml-4">&lt;/h1&gt;</span>
          </div>
          {/* Content about me */}
          <div className="text-xl row-span-4 h-full relative">
